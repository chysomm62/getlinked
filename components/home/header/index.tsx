...
const Header: FC<refTypes> = ({
  ...
  const clickHandler = () => {};
  return (
    <header ref={overviewRef} className={` font-montserrat line`}>
      <Nav
      ...
      <div className={`${styles.hero}`}>
        <div
          className={`md:flex items-center justify-end py-5 max-w-screen-xl mx-auto text-center`}
        >
          <span
            className={`text-white text-center md:text-right text-base mx-auto md:mx-0 md:text-4xl font-bold italic font-montserrat ${styles.innova} `}
          >
